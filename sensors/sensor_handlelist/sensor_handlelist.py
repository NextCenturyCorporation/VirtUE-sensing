...
async def assess_handlelist(message_stub, config, message_queue):
    ...
    print(" ::starting handlelist check-summing")
...
async def handlelist(message_stub, config, message_queue):
    """
    Run the handlelist command and push messages to the output queue.
    ...
    print(" ::starting handlelist (pid=%d)" % (self_pid,))
